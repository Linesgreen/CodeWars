...
Examples
    ...
    let b = new Block([2,4,6]) ---->    creates a `Block` object 
        with a width of `2` a length of `4` and a height of `6`
...
class Block{
    ...
    constructor(data){
      ...
      getSurfaceArea() {return 2 * (this.width * this.length + 
                                    this.width * this.height + 
                                    this.length *  this.height)}
  }


  let bob = new Block([2,4,6]);
  console.log(bob.getSurfaceArea());